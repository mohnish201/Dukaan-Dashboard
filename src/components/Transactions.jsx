...
const Transactions = () => {
  return (
    <div class="w-full px-8 my-8 flex-col justify-start items-start gap-5 inline-flex">
      <div class="flex-col justify-start items-start gap-5 flex">
        ...
        <div class="justify-start items-start gap-3 inline-flex">
          <div class="px-4 py-1.5 bg-sky-700 rounded-3xl justify-start items-center gap-1.5 flex">
            <div class="text-white text-sm font-medium font-['Inter'] leading-tight">
              Payouts (22)
            </div>
          </div>
          <div class="px-4 py-1.5 bg-neutral-200 rounded-3xl justify-start items-center gap-2.5 flex">
            <div class="text-zinc-500 text-sm font-medium font-['Inter'] leading-tight">
              Refunds (2)
            </div>
          </div>
        </div>
      ...
      <div className="flex justify-between w-full items-center bg-white p-2 ">
        <div className="flex items-center space-x-2 border-2 rounded-sm px-4 py-2 border-[#D9D9D9]">
          <div>
            <svg
              ...
              fill="none"
            >
              <g clip-path="url(#clip0_84638_21800)">
                <path
              ...
              <defs>
                <clipPath id="clip0_84638_21800">
                  <rect width="14" height="14" fill="white" />
                </clipPath>
              </defs>
            </svg>
          </div>
          <input type="text" placeholder="Order ID or transaction ID" className="text-xs border-none focus-visible:border-none font-normal leading-snug" />
        </div>

        <div class="w-32 h-9 justify-end items-center gap-4 inline-flex">
          <div class="justify-start items-center gap-3 flex">
            <div class="px-3 py-1.5 bg-white rounded border border-zinc-300 justify-start items-center gap-1.5 flex">
              <div class="text-neutral-600 text-base font-normal font-['Inter'] leading-normal">
                Sort
              </div>
          ...
          <div class="w-9 h-9 relative">
            <div class="w-9 h-9 left-0 top-0 absolute rounded border border-zinc-300"></div>
            <div class="w-5 h-5 left-[8px] top-[8px] absolute">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
