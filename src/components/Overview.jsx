...
const Overview = () => {
  return (
    <div class="w-full px-8 h-40 justify-start items-start gap-5 inline-flex">
      <div class="grow shrink basis-0 shadow rounded-lg bg-sky-700 flex-col justify-center inline-flex">
        <div class="self-stretch p-5 bg-sky-700 rounded-lg flex-col justify-start items-start gap-4 flex">
          <div class="self-stretch h-20 flex-col justify-start items-start gap-4 flex">
            <div class="self-stretch justify-between items-center inline-flex">
              <div class="justify-start items-center gap-2 flex">
                <div class="text-white text-base font-normal font-['Galano Grotesque'] leading-normal">
                  Next Payout
                </div>
            ...
            <div class="self-stretch justify-between items-center inline-flex">
              <div class="text-white text-3xl font-medium font-['Galano Grotesque'] leading-9">
                ₹2,312.23
              </div>
              <div class="justify-start items-center flex">
                <div class="justify-start items-start gap-2 flex">
                  <div class="text-white text-base font-medium font-['Galano Grotesque'] underline leading-normal">
                    23 orders
                  </div>
                </div>
        ...
        <div class="w-full px-6 py-2 bg-sky-800 rounded-lg justify-between items-start inline-flex">
          <div class="text-zinc-100 text-sm font-normal font-['Galano Grotesque'] leading-tight">
            Next payout date:
          </div>
          <div class="text-zinc-100 text-sm font-medium font-['Galano Grotesque'] leading-tight">
            Today, 04:00PM
          </div>
        </div>
      </div>
      <div class="grow shrink basis-0 h-28 justify-center items-center gap-6 flex">
        <div class="grow shrink basis-0 p-5 bg-white rounded-lg shadow flex-col justify-start items-start gap-4 inline-flex">
          <div class="self-stretch h-20 flex-col justify-start items-start gap-4 flex">
            <div class="justify-start items-center gap-2 inline-flex">
              <div class="text-neutral-600 text-base font-normal font-['Galano Grotesque'] leading-normal">
                Amount Pending
              </div>
              <div class="w-4 h-4 relative">
                <svg
            ...
            <div class="self-stretch justify-between items-center inline-flex">
              <div class="text-zinc-900 text-3xl font-medium font-['Galano Grotesque'] leading-9">
                ₹92,312.20
              </div>
              <div class="justify-start items-center flex">
                <div class="justify-start items-start gap-2 flex">
                  <div class="text-sky-700 text-base font-medium font-['Galano Grotesque'] underline leading-normal">
                    13 orders
                  </div>
                </div>
                <div class="w-6 h-6 relative">
      ...
      <div class="grow shrink basis-0 h-28 justify-center items-center gap-6 flex">
        <div class="grow shrink basis-0 p-5 bg-white rounded-lg shadow flex-col justify-start items-start gap-4 inline-flex">
          <div class="self-stretch h-20 flex-col justify-start items-start gap-4 flex">
            ...
            <div class="self-stretch justify-between items-center inline-flex">
              <div class="grow shrink basis-0 h-9 justify-between items-center flex">
                <div class="text-zinc-900 text-3xl font-medium font-['Galano Grotesque'] leading-9">
                  ₹23,92,312.19
                </div>
              </div>
