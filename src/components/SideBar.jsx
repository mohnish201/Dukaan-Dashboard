...
const SideBar = () => {
  return (
    <div className="fixed">
      <div class="w-56 h-screen flex-col justify-start items-start inline-flex">
        <div class="w-56 grow shrink basis-0 px-2.5 py-4 bg-slate-800 flex-col justify-start items-center gap-4 flex">
          <div class="w-52 grow shrink basis-0 flex-col justify-start items-center gap-6 flex">
            <div class="w-48 justify-start items-center gap-3 inline-flex">
              <div class="w-10 h-10 bg-white rounded">
                <img src={logo} alt="logo" />
              </div>
              {/* <img class="w-10 h-10 rounded" src="https://via.placeholder.com/39x39" /> */}
              <div class="grow shrink basis-0 flex-col justify-center items-start gap-1 inline-flex">
                <div class="self-stretch text-white text-base font-medium font-['Galano Grotesque'] leading-snug">
                  Nishyan
                </div>
                <div class="self-stretch opacity-80 text-white text-xs font-normal font-['Galano Grotesque'] underline leading-none">
                  Visit store
                </div>
              </div>
            ...
            <div class="w-52 grow shrink basis-0 flex-col justify-start items-start gap-1 flex">
              <div class="w-52 px-4 py-2 hover:bg-white hover:bg-opacity-10 hover:text-white cursor-pointer rounded justify-start items-start gap-3 inline-flex">
                ...
                <div class="opacity-80 text-white hover:text-white hover:opacity-100 text-sm font-medium font-['Galano Grotesque'] leading-tight">
                  Home
                </div>
              </div>
              <div class="w-52 px-4 py-2 hover:bg-white hover:bg-opacity-10  cursor-pointer hover:text-white rounded justify-start items-start gap-3 inline-flex">
                <div class="w-5 h-5 relative opacity-80">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
              ...
              <div class="w-52 px-4 py-2 hover:bg-white hover:bg-opacity-10 cursor-pointer hover:text-white bg-white bg-opacity-10 rounded justify-start items-start gap-3 inline-flex">
                <div class="w-5 h-5 relative">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                ...
                <div class="text-white text-sm  font-medium font-['Galano Grotesque'] leading-tight">
                  Payouts
                </div>
              </div>
              <div class="w-52 px-4 py-2 hover:bg-white hover:bg-opacity-10 cursor-pointer hover:text-white rounded justify-start items-start gap-3 inline-flex">
                <div class="w-5 h-5 relative opacity-80">
                  <svg
                    ...
                    fill="none"
                  >
                    <g opacity="0.8" clip-path="url(#clip0_84565_2393)">
                      <path
              ...
              <div class="w-52 px-4 py-2 hover:bg-white hover:bg-opacity-10 cursor-pointer hover:text-white rounded justify-start items-start gap-3 inline-flex">
                <div class="w-5 h-5 relative opacity-80">
                  <svg
                    ...
                    fill="none"
                  >
                    <g opacity="0.8" clip-path="url(#clip0_84565_2403)">
                      <path
          ...
          <div class="h-14 px-3 py-1.5 bg-slate-700 rounded flex-col justify-start items-start gap-2.5 flex">
            <div class="justify-start items-center gap-3 inline-flex">
              <div class="p-1.5 bg-white bg-opacity-10 rounded justify-start items-start gap-2.5 flex">
                <div class="w-6 h-6 relative">
                  <img
                    class="w-6 h-5 left-[0.20px] top-[2.20px] absolute"
                    src="https://via.placeholder.com/24x20"
                  />
                </div>
              </div>
              <div class="flex-col justify-start items-start gap-0.5 inline-flex">
                <div class="opacity-80 text-white text-xs font-normal font-['Galano Grotesque'] leading-none">
                  Available credits
                </div>
                <div class="text-white text-base font-medium font-['Galano Grotesque'] leading-normal">
                  222.10
                </div>
              </div>
            </div>
